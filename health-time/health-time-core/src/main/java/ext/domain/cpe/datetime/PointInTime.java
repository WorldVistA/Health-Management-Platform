 ...
 * package private.</p>
 */
public final class PointInTime implements ReadablePartial, Comparable, Serializable, Cloneable {
    ...
    public PointInTime add(ReadablePeriod p) {
        return new PointInTime(this.partial.plus(p));
    }
    ...
    public PointInTime subtract(ReadablePeriod p) {
        return new PointInTime(this.partial.minus(p));
    }
    ...
    public static PointInTime now() {
        return fromLocalDateTime(new LocalDateTime());
    }

    public static PointInTime today() {
        return fromLocalDate(new LocalDate());
    }
}
