...
public class JsonCResponse<R> {
    ...
    public JsonCResponse setMethodAndParams(HttpServletRequest request) {
    ...
    public JsonCResponse setError(String code, String message) {
    ...
    public JsonCResponse addError(String code, String message) {
        if (this.data != null) this.data = null;
        if (this.error == null) this.error = new Error();

        if (this.error.errors == null) {
            this.error.errors = new ArrayList<Map<String, String>>();
        }
    ...
    public JsonCResponse setError(String code, Exception e) {
        if (this.data != null) this.data = null;
        if (this.error == null) this.error = new Error();
        ...
        this.error.errors = (List<Map<String, String>>) Collections.singletonList(error);
