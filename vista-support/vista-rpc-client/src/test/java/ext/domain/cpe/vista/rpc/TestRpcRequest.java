...
//        assertEquals("vrpcb://960:10vehu;vehu10@localhost:9060/FOO/BAR?timeout=30", r.getURI().toString());
        assertEquals("vrpcb://localhost:9060/FOO/BAR?timeout=30", r.getURI().toString());
    ...
    public void constructFromAmbiguousHostUri() {
        ...
        assertEquals("vrpcb://9F06/FOO%20BAR/BAZ%20SPAZ?timeout=30", r.getURI().toString());
...
//        assertEquals("vrpcb://960:10vehu;vehu10@localhost:9060/FOO/BAR?timeout=30", r.getURI().toString());
    ...
    public void constructFromVistaLinkUri() {
        ...
        assertEquals("vlink://localhost:9060/FOO/BAR?timeout=30", r.getURI().toString());
    ...
    public void constructFromRelativeUri() {
        ...
        assertEquals("/FOO/BAR?timeout=30", r.getURI().toString());
    ...
    public void constructFromRelativeUriNoRpcContext() {
        ...
        assertEquals("/BAR?timeout=30", r.getURI().toString());
        assertNull(r.getHost());
        assertNull(r.getCredentials());
